...
local pt_BR = {
    ...
    ["Showing network information. Tap to show reading information."] = "Exibindo informações da rede. Toque para mostrar as informações de leitura.",
    ["Showing reading information. Tap to show network information."] = "Exibindo informações de leitura. Toque para mostrar as informações da rede.",
    ["Connected"] = "Conectado",
    ...
    ["Reset the Quick Dock buttons and their order to the defaults?"] = "Restaurar os botões do Quick Dock e sua ordem padrão?",
    ["Reset Quick Dock behavior to its defaults? Your buttons and their order will be kept."] = "Restaurar o comportamento padrão do Quick Dock? Os botões e sua ordem serão mantidos.",
    ["Reset Quick Dock behavior and buttons to their defaults? Appearance settings will be kept."] = "Restaurar o comportamento e os botões padrão do Quick Dock? As configurações de aparência serão mantidas.",
    ...
    ["Uses a dedicated icon for the visible reading or network information panel."] = "Usa um ícone específico para o painel de leitura ou de rede exibido.",
    ...
    ["Buttons and order: %1"] = "Botões e ordem: %1",
    ["Choose the actions shown in the dock and arrange their order."] = "Escolha as ações mostradas na dock e organize sua ordem.",
    ["Dock controls"] = "Controles da dock",
    ["Show or hide the reader/browser, side-switch, and close controls."] = "Mostre ou oculte os controles de leitor/navegador, troca de lado e fechamento.",
    ...
    ["Shows the open book's cover above the reading information. The thumbnail is loaded once and reused while the document remains open."] = "Mostra a capa do livro aberto acima das informações de leitura. A miniatura é carregada uma vez e reutilizada enquanto o documento permanece aberto.",
    ...
    ["Expected icon filenames"] = "Nomes esperados dos arquivos de ícones",
    ["Shows the custom SVG and PNG filenames expected for each dock action."] = "Mostra os nomes dos arquivos SVG e PNG personalizados esperados para cada ação da dock.",

    ["Reset behavior to defaults"] = "Redefinir comportamento para o padrão",
    ["Restores gesture-following placement, right-side fallback, and one-block-at-a-time closing without changing actions, buttons, or appearance."] = "Restaura a posição pelo gesto, o lado direito padrão e o fechamento de um bloco por vez sem alterar ações, botões ou aparência.",
    ["Reset buttons to defaults"] = "Redefinir botões para o padrão",
    ["Restores the initial buttons and their order without changing other Quick Dock settings."] = "Restaura os botões iniciais e sua ordem sem alterar outras configurações do Quick Dock.",
    ["Reset behavior and buttons"] = "Redefinir comportamento e botões",
    ["Restores behavior, dock controls, default actions, order, and action visibility while keeping appearance settings."] = "Restaura comportamento, controles da dock, ações padrão, ordem e visibilidade, mantendo as configurações de aparência.",
    ...
    ["Actions and buttons"] = "Ações e botões",
    ["Configure actions, dock controls, ordering, and contextual visibility."] = "Configure ações, controles da dock, ordem e visibilidade por contexto.",
    ...
    ["Restore default behavior, with or without resetting buttons."] = "Restaure o comportamento padrão, com ou sem redefinir os botões.",
...
local pt_PT = setmetatable({
    ...
    ["Shows the open book's cover above the reading information. The thumbnail is loaded once and reused while the document remains open."] = "Mostra a capa do livro aberto acima das informações de leitura. A miniatura é carregada uma vez e reutilizada enquanto o documento permanece aberto.",
    ["Restores the initial buttons and their order without changing other Quick Dock settings."] = "Restaura os botões iniciais e a sua ordem sem alterar outras definições do Quick Dock.",
    ["Reset Quick Dock behavior to its defaults? Your buttons and their order will be kept."] = "Restaurar o comportamento padrão do Quick Dock? Os botões e a sua ordem serão mantidos.",
    ["Reset Quick Dock behavior and buttons to their defaults? Appearance settings will be kept."] = "Restaurar o comportamento e os botões padrão do Quick Dock? As definições de aparência serão mantidas.",
    ["Gesture setup"] = "Configuração de gestos",
