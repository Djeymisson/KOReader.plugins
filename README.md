...
| Lookup Preview | v1.0.11 | `lookuppreview.koplugin/` | [lookuppreview.koplugin.md](./lookuppreview.koplugin.md) |
...
| Shortcut Dock | v0.6.2 | `shortcutdock.koplugin/` | [shortcutdock.koplugin.md](./shortcutdock.koplugin.md) |
